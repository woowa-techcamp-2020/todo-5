...
class Topic extends HTMLElement {
	...
	private listeners(): void {
		...
		addButton.addEventListener('click', (e: Event): void => this.openInputAndDisabled(e));
		closeButton.addEventListener('click', this.openCloseModal.bind(this));
		topicTitle.addEventListener('dblclick', this.openEditModal.bind(this));
	}
	...
	private async editTopicTitle(title: string): Promise<void> {
		const body = {
