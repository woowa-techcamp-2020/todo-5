...
class CardController {
  ...
  static async create(req: Request, res: Response, next: NextFunction) {
   ...
   static async getCardsByTopicId(req: Request, res: Response, next: NextFunction) {
    ...
    try {
      ...
      .json(JsonResponse(httpStatus.OK, 'cards get well', response));
    } catch(err) {
  ...
  static async update(req: Request, res: Response, next: NextFunction) {
    ...
    try {
      ...
      res.status(httpStatus.OK)
      .json(JsonResponse(httpStatus.OK, 'card updated well', response));
    } catch(err) {
  ...
  static async delete(req: Request, res: Response, next: NextFunction) {
    ...
    try {
      ...
      res.status(httpStatus.OK)
      .json(JsonResponse(httpStatus.OK, 'card deleted well', response));
    } catch(err) {
